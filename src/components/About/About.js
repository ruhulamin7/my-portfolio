  ...
  return (
    <Container className="about-container">
      <Row md={2} sm={1} xs={1}>
        ...
        <Col className="about-right pt-5">
          <div data-aos="fade-up">
            ...
            <p>
              I look forward to sharing more about my skills and experiences.
              Feel free to contact me at +88 01739713724 or
              ruhulaminbd99@gmail.com.
            </p>
            <p>
